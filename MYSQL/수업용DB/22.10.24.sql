...
-- 테이블 bookmarketdb.galleryboard 구조 내보내기
CREATE TABLE IF NOT EXISTS `galleryboard` (
  `num` int NOT NULL AUTO_INCREMENT,
  `name` varchar(10) NOT NULL,
  `subject` varchar(100) NOT NULL,
  `content` text NOT NULL,
  ...
  `fileseize` mediumtext,
  PRIMARY KEY (`num`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;

-- 테이블 데이터 bookmarketdb.galleryboard:~0 rows (대략적) 내보내기
/*!40000 ALTER TABLE `galleryboard` DISABLE KEYS */;
/*!40000 ALTER TABLE `galleryboard` ENABLE KEYS */;

-- 테이블 bookmarketdb.member 구조 내보내기
...
-- 테이블 데이터 projectdb.board:~1 rows (대략적) 내보내기
/*!40000 ALTER TABLE `board` DISABLE KEYS */;
INSERT INTO `board` (`num`, `id`, `name`, `subject`, `content`, `regist_day`, `hit`, `ip`) VALUES
	(1, 'pks4877', '박근수', 'ㅁㄴㅇ', 'ㅁㄴㅇ', '2022년 10월 24일', 2, '0:0:0:0:0:0:0:1');
/*!40000 ALTER TABLE `board` ENABLE KEYS */;
...
-- 테이블 데이터 webmarketdb.board:~4 rows (대략적) 내보내기
/*!40000 ALTER TABLE `board` DISABLE KEYS */;
INSERT INTO `board` (`num`, `id`, `name`, `subject`, `content`, `regist_day`, `hit`, `ip`) VALUES
	(1, 'gumi', '이순신', '설맞이', '새해복많이..', '2022-10-05 13:47:42', 11, ''),
	(3, 'pks4877', '박근수', '123567', '1234', '2022-10-07 11:42:50', 15, '0:0:0:0:0:0:0:1'),
	(4, 'admin', 'admin', '123', '123', '2022-10-22 17:43:01', 7, '0:0:0:0:0:0:0:1'),
	(6, 'pks4877', '박근수', 'ㅎㅇㅎㅇ', 'ㅎㅇㅎㅇ', '2022-10-22 18:14:39', 0, '0:0:0:0:0:0:0:1');
/*!40000 ALTER TABLE `board` ENABLE KEYS */;
