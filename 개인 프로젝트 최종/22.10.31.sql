...
INSERT INTO `reservation` (`r_number`, `r_id`, `r_adults`, `r_kids`, `r_checkin`, `r_checkout`, `r_type`, `r_price`, `r_time`) VALUES
	(1, 'pks4877', 2, 0, '2022-11-01', '2022-11-02', '그랜드 디럭스 룸', 560000, 1),
	(4, 'pks4877', 1, 0, '2022-11-02', '2022-11-03', '시그니엘 프리미어 룸', 650000, 1),
	(6, 'pks4877', 1, 0, '2022-11-02', '2022-11-03', '디럭스 스위트 룸', 980000, 1);
...
-- 테이블 데이터 projectdb.room:~8 rows (대략적) 내보내기
