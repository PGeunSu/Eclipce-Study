									...
									<div class="d513">
										...
										<div class="d513-detail-view">
											<div class="slickNew" style="opacity: 1;"> 
												<img src="../images/reservation/${param.room_img}">
											</div>
												...
												<div class="section-info currnecy-check">
													...
													<div class="column">
														<div class="select-info ui-reservation-options-wrap">
															...
															<div class="use-person-info">${param.r_adults},${param.r_kids}
																	...
																	<div class="info-item">
																		...
																		<div class="add-btn-group">
																			<div class="add-btn">
																				...
																				<div class="d513-person__count otp-bfa-control"> <!-- 조식 신청 버튼 --></div>
																			</div>
																		</div>
																	</div>
																	<div class="info-item">
																	...
																	<!-- 체크인 날짜에 따른 객실 요금 -->
																		<p class="tit">
																			...
																			<span class="option-txt">
																				...
																				<span class="price-txt">
																					<span class="price roomPrice"> <!-- 객실 요금 -->KRW</span>
																				</span>
																			</span>
																		</p>
																		<!-- 옵션 요금 (조식) -->
																		<p class="tit">
																			<span class="label-txt">옵션 요금</span>
																			<span class="label-txt sub">조식신청 (성인)</span>
																			<span class="option-txt bfa-area">
																				성인 조식
																				<span class="price-txt">
																					<span class="price otp-bfa-target-price"><!-- 성인 조식 요금 --></span>
																				</span>
																			</span>
																			<span></span>
																		</p>
																		...
																		<p class="tit tax-area">
																			...
																			<span class="price-txt">
																				<span class="price taxPrice"> <!-- 세금 --></span>
																			</span>
																		</p>
																		<!-- 총 합계 금액 -->
																		<p class="total-price total-price-area">
																			객실<em>1</em> 총 요금
																			<span class="price-txt">
																				<span class="price totalPrice"><!-- 객실 총 요금 --></span>
																			</span>
																		</p>
																	</div>
																</div>
