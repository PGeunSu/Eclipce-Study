...
public class ReplyDAO {
	...
	public ReplyDAO() {
		try {
			String dbURL="jdbc:mysql://localhost:3307/ProjectDB&useSSL=false";	
			String id="root";
	...
	public ArrayList<Reply> getList(int id,int pageNumber){
	...
	public int write(int id,String replyContent,String userID) {
