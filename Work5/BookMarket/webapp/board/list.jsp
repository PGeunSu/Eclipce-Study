...
<%
String sessionId=(String)session.getAttribute("sessionId"); ArrayList<BoardDTO> boardList =
			...
			<form action='<c:url value="./boardListAction.do" />' method="post">
				...
				<div style="padding-top:50px">
					...
					<table class="table table-hover">
						...
						<%
						for(int i=0; i<boardList.size(); i++) { BoardDTO notice=boardList.get(i);
						%>
							...
							<tr>
								...
								<td><a
										href="./boardViewAction.do?num=<%=notice.getNum() %>&pageNum=<%=pageNum%>">
										<%=notice.getSubject() %>
									</a></td>
								<td>
									<%=notice.getRegist_day() %>
								</td>
								<td>
									<%=notice.getHit() %>
								</td>
						...
						<table>
							<tr>
								...
								<td width="100%" align="right">
									...
									<h3><a href="#" onclick="checkForm()"
											class="badge badge-primary">글쓰기</a></h3>
								</td>
							</tr>
						</table>
					</div>
