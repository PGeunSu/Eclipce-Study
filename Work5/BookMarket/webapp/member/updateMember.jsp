...
%>
	...
	<sql:setDataSource var="dataSource" url="jdbc:mysql://localhost:3307/BookMarketDB"
...
<body onload="init()">
	...
	<c:forEach var="row" items="${resultSet.rows}">
		...
		<!-- @ 기준으로 앞에 있는 것은 mail1으로 저장 뒤에 있는 것은 mail2로 저장 -->
		...
		onsubmit = "return checkForm()">
			...
			<div class="form-group  row">
				<div class="col-sm-offset-2 col-sm-10 ">
					...
					<input type="button" class="btn btn-danger" value="회원 탈퇴" onclick="return deleteMemberConfirm()"> 
			    </div>
			</div>
		</form>
...
<script type="text/javascript">
	...
	function setComboMailValue(val){
		...
		//(db)매개변수로 넘어온 val라는 값과 (jsp) select태그의 값이 동일하다면 그 부분이 select되었다고 true로 설정
