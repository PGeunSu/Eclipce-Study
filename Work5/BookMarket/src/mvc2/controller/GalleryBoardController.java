...
import mvc2.model.GalleryBoardDAO;
import mvc2.model.GalleryBoardDTO;
import mvc2.model.GalleryRippleDTO;
...
public class GalleryBoardController extends HttpServlet {
	...
	public void requestGalleryBoardWrite(HttpServletRequest request) {
		...
		if (file1 != null) {
			...
			System.out.print("����ũ��111 " + filesize);
		}
		System.out.print("����ũ�� " + filesize);
		System.out.print("����ũ�� " + filename);
		GalleryBoardDAO dao = GalleryBoardDAO.getInstance();
