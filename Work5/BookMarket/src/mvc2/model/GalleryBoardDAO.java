...
public class GalleryBoardDAO {
	...
	public List<GalleryBoardDTO> getGalleryBoardList(int page, int limit, String items, String text) {
		...
		try {
			...
			System.out.println("getGalleryBoardList() ���� : " + ex);
		} finally {
			try {
				if (rs != null) {
					rs.close();
	...
	public void insertGalleryBoard(GalleryBoardDTO galleryboard)  {
		...
		try {
			...
			System.out.println("insertGalleryBoard() ���� : " + ex);
		} finally {
			try {				
				if (pstmt != null) {
					pstmt.close();
	...
	public GalleryBoardDTO getGalleryBoardByNum(int num, int page) {
		...
		try {
			...
			System.out.println("getGalleryBoardByNum() ���� : " + ex);
		} finally {
			try {
				if (rs != null) {
					rs.close();
	...
	public void updateGalleryBoard(GalleryBoardDTO galleryboard) {
		...
		try {
			...
			System.out.println("updateGalleryBoard() ���� : " + ex);
		} finally {
			try {				
				if (pstmt != null) {
					pstmt.close();
	...
	public void deleteGalleryBoard(int num) {
		...
		try {
			...
			System.out.println("deleteGalleryBoard() ���� : " + ex);
		} finally {
			try {
	...
	public List<GalleryRippleDTO>  getGalleryBoardRippleByNum(int num, int page) {
		...
		try {
			...
			System.out.println("getGalleryBoardRippleByNum() ���� : " + ex);
		} finally {
			try {
				if (rs != null) {
					rs.close();
	...
	public void insertGalleryRipple(GalleryRippleDTO galleryboard)  {
		...
		try {
			...
			System.out.println("insertGalleryRipple() ���� : " + ex);
		} finally {
			try {				
				if (pstmt != null) {
					pstmt.close();
	...
	public void deleteGalleryRipple(int num) {
		...
		try {
			...
			System.out.println("deleteGalleryRipple() ���� : " + ex);
		} finally {
			try {
